...
const Services: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Physiotherapy Services - ProHealth London | Expert Treatment & Rehabilitation</title>
        <meta name="description" content="Comprehensive physiotherapy services in London including sports injury treatment, back pain relief, post-surgery rehabilitation, and manual therapy. Book today." />
        <meta name="keywords" content="physiotherapy services, sports injury treatment, back pain relief, post-surgery rehabilitation, manual therapy, London" />
      </Helmet>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-100 leading-relaxed">
              Comprehensive physiotherapy and rehabilitation services tailored to your specific needs and recovery goals.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <div key={index} id={service.id} className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold mb-2 text-primary-blue-dark">{service.title}</h3>
                    ...
                    <div className="mb-4">
                      <h4 className="font-semibold text-primary-blue-dark mb-2">What's Included:</h4>
                    ...
                    <div className="mb-6">
                      <h4 className="font-semibold text-primary-blue-dark mb-2">Common Conditions:</h4>
                      <div className="flex flex-wrap gap-2">
                        {service.conditions.map((condition, idx) => (
                          <span key={idx} className="bg-primary-green/10 text-primary-green text-xs px-3 py-1 rounded-full">
                            {condition}
                          </span>
                        ))}
                      </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle">
              A structured approach to ensure you receive the most effective care for your condition.
            </p>
          </div>
            ...
            {treatmentProcess.map((step, index) => (
              <div key={index} className="relative">
                <div className="bg-white rounded-xl p-6 text-center shadow-lg">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-primary-blue-dark">{step.title}</h3>
      ...
      <section className="section-padding bg-white">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6 text-primary-blue-dark">Why Choose Our Services?</h2>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-primary-green mt-1" />
                  <div>
                    <h3 className="font-semibold text-primary-blue-dark">Evidence-Based Treatment</h3>
                    <p className="text-gray-600">All our treatments are based on the latest research and clinical evidence.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-primary-green mt-1" />
                  <div>
                    <h3 className="font-semibold text-primary-blue-dark">Personalized Care</h3>
                    <p className="text-gray-600">Every treatment plan is tailored to your specific condition and goals.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-primary-green mt-1" />
                  <div>
                    <h3 className="font-semibold text-primary-blue-dark">Qualified Professionals</h3>
                    <p className="text-gray-600">Our team consists of highly qualified and experienced physiotherapists.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-primary-green mt-1" />
                  <div>
                    <h3 className="font-semibold text-primary-blue-dark">Modern Equipment</h3>
                    <p className="text-gray-600">We use the latest technology and equipment for optimal results.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="section-padding bg-gradient-to-r from-primary-green to-primary-blue-light text-white">
        <div className="container text-center">
          ...
          <p className="text-xl text-gray-100 mb-8 max-w-2xl mx-auto">
            Take the first step towards recovery and book your consultation with our expert physiotherapists.
          </p>
